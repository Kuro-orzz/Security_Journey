...
- Mục tiêu là 1 website mà nếu chỉ nhìn qua sẽ ko thấy có gì đặc biệt, rất ít tính năng để có thể pentest ra được bug. Tuy nhiên, có 1 tính năng đã lọt được vào mắt xanh của mình, đó là upload avatar feature. (hoặc đơn giản là vào đúng giai đoạn mình đang đọc thêm về cái này và thiếu chỗ để test:)))
- Để mà nói thì thực ra từ đầu kì trước mình đã để ý đến phần này rồi, nhưng lúc đó mình chưa có đủ kiến thức nên pentest ko ra tí bug nào cả;))
...
- Dựa vào đó, mình thử đọc logic của nó và thấy web in ra là chỉ cho phép file ext `jpg, bmp, png`, nhưng trong code thì còn cho phép cả file `gif` nữa.
- Đến đó thì mình bắt tay vào thử luôn.

### Phase 2: Scanning and Enumeration
- Ban đầu thì mình chuyên tâm vào gif hơn vì nghĩ có nhiều khả năng injection hơn, nhưng điểm qua vài trick lỏd mà vẫn không được nên mình quyết định gác lại chuyển qua đọc CVE, CWE-34, CWE-434 hay cả một số các CVE khác liên quan đến nó, thậm chí là dò hỏi Gemini liên tục.
...
- Lúc này, mình đã lên lớp ngồi học, nhưng cố tình xuống bàn cuối ngồi một mình để tiện cho quá trình pentest web.
...
- Tới tối hôm đó, do một chút cố chấp ko muốn dùng privilege do ko quen (lúc đó mình cứ nghĩ là nó khó dùng cơ), mình thuần nhờ gemini giúp để thu thập thông tin, nhưng kết quả ko đạt được gì cả.
- Sau hơn 1 tiếng lãng phí thì mình bắt đầu nghĩ tới việc tự tạo 1 lab Windows server có RCE để test. Và vì nó tốn chi phí để duy trì nên mình đã nghĩ cần phải nhanh chóng pentest được web ngay trong tuần này, tránh kéo dài vì sẽ mất thêm money.
...
- Đến chiều hôm đó, mình nán lại giảng đường, và định bụng đợi đến tầm 1h mới đi ăn trưa, đó cũng chính là lúc mình bắt đầu mở máy và ngồi nghiền ngẫm blog kia. Do đọc cuốn quá nên mình lỡ quên mất cả ăn trưa và ngồi liền mạch luôn đến gần 5r mới về, may trong cặp vẫn còn bánh ăn lót dạ:))
- Trong buổi chiều đó, mình đã thu về được kha khá thông tin hữu ích:
    - Đầu tiên, trên lab tự setup của mình thì PrintSpoofer đã bị chặn bởi Windows Defender và ko thể tải xuống được (nó liên tục bị auto delete)
    - Tuy nhiên, sau đó mình thử encode bằng base64 thành text sau đó mới tải lên server rồi mới decode. Thực ra thì cách này cũng vẫn bị Windows Defender bắt được và ko thành công;))
    ...
    - Nhờ đó mình đi đến 1 kết luận là khả năng server đã tắt Windows Defender, có thể là do trong quá trình code, 1 số file .asp đã bị xóa do sự nhầm lẫn là malicious code (lúc mình thử tải về máy thì cũng có vài file bị detect nhầm và bị delete mất). Chắc admin phải cay lắm nên mới tắt đi hoặc vì lý do nào đó không rõ:))
- Với thu hoạch có trong tay, mình khá vui khi đã lần đầu tiên thành công trong việc leo thang đặc quyền trên Windows.
...
- Đến lúc này, mình hỏi gemini thường xuyên hơn, nhưng do 1 số thứ misleading trong response của gemini đã khiến mình lầm tưởng rằng server ko có code, và code có thể được sử dụng thông qua 1 vị trí khác ngoài ổ cứng (đây là do tôi ko quen thôi;)), lúc đó kể cả database cũng ko thể thao tác được do ko có được credential hay password để xác thực.
- Thực sự thì tối hôm đó hơi ác mộng 1 chút, nắm full quyền trong tay nhưng lại ko thể tìm thấy thứ thực sự có giá trị làm tôi ngồi prompt cả tối hôm đó mà lại tiếp tục thu được rất ít thông tin.

## Day 3:

### Phase 5: Explore
- Dù tối hôm qua ngủ trễ nhưng sáng nay mình vẫn dậy khá sớm, lúc này tinh thần đã lên cao và sẵn sàng chiến tiếp.
- Lúc này đầu óc đã tỉnh táo và thông suốt hơn 1 chút, mình bắt đầu nhớ tới Recycle Bin và nghĩ biết đâu trong này có gì đáng giá nhỉ, nghĩ xong cái là mình bắt tay vào tìm luôn, thì quả nhiên trong đó có 1 số sensitive data.
...
- Sau đó mình check thấy 1 số file .asp trong đó, cùng 1 số thứ linh tinh như logs, hay gì đó đi kèm. 
    - Đến mãi sau này lúc có source code mình check lại thấy khá giống đống file .asp này, nhưng không hiểu sao nó lại xếp lại chung 1 folder và được đánh số nữa.
    - Đến tận bây giờ thì mình lại có 2 luồng suy nghĩ rằng, 1 là có thể do admin để thế, 2 là có thể tồn tại một người nào đó có chung suy nghĩ với mình và xếp lại một folder để tiện download về local. Tại nếu để nguyên cấu trúc folder thì nó khá nặng và khó để download về (mình sẽ nói trong phần dưới).
...
- Tối hôm đó, trong lúc đi ăn mình đã nghĩ tới 1 khả năng, có khi nào có nhiều hơn 1 ổ cứng trong máy ko nhỉ? Thế là mình ăn vội rồi chạy tót lên phòng. Và quả thật trời ko phụ người, cuối cùng thì mỏ vàng thật sự đã hiện ra trước mắt.
    - Thực ra nếu để ý kĩ trong đống logs nhặt được ở trên thì có một vài path dẫn sang cả ổ khác, nhưng lúc này mình vẫn chưa đọc kĩ nên ko nhận ra được.
...
- Đó mới thật sự là vớ được kho báu, mình bắt đầu nhờ gemini generate ra một đoạn webshell viết bằng .asp để injection vào web thông qua upload avatar.
- Cũng chính từ đó, mình bắt đầu tìm cách tải toàn bộ database xuống và nắm trong tay quyền sinh sát thật sự.
- Ban đầu mình tính tải toàn bộ, mỗi table 1 file .csv, nhưng có vẻ như do nhiều data quá, tràn buffer, nên việc này thậm chí còn làm treo mất cả shell của mình. Lúc đó mình còn cảm thấy có hơi sợ, lỡ mà làm sập web thì shell của mình cũng oẳng luôn thì sao 😱.
- Nhưng cũng may mà đoạn webshell của gemini có tự động dừng sau khoảng 10p nếu không xong nên mình thoát nạn một phen.
- Sau đó tiếp tục áp dụng tư tưởng chia để trị 🤡, mình chia table thành file nhỏ hơn, mỗi file chỉ có khoảng n rows, đủ để tải về mà ko có bất trắc gì.  
- Nhưng khi đó, một vấn đề mới lại xuất hiện, đó là password của user ko được lưu dưới dạng text mà được băm qua hàm MD5. Lúc này mình vẫn chưa biết gì về cách reverse hash MD5, thứ duy nhất mình biết về nó là hay dùng để lưu password giống bcrypt, argon2 nhưng được đánh giá là yếu hơn.
- Sau đó mình có thử research đủ thứ liên quan về nó, như các cách bruteforce, rainbow table hay hash collision attack. Nhưng đa phần tool mình tìm được ko có custom MD5 mà thuần bruteforce hay pre compute nên vẫn ko đủ tốt để sử dụng.
- Và mình thử hỏi gemini xem liệu có tool nào trên kali linux hữu ích ko, và cuối cùng cũng tìm ra được chân ái, đó chính là John the Ripper.
- Đây là lần đầu tiên mình sử dụng nó, và thấy nó khá hữu dụng khi hỗ trợ cả custom cho các cách hash khác nhau. Do nắm trong tay source code nên mình còn sở hữu cả Salt và cách nó hash MD5. Nhờ đó quá trình diễn ra khá nhanh.
    - Thực tế thì tốc độ của John sẽ nhanh hơn nếu có GPU, và có cả đa luồng.
    - Do mấy tool kiếm được trên github đa phần toàn reverse hash theo kiểu ko biết trước salt hoặc chỉ dành cho MD5 bình thường, nên mình cũng lười ngồi đọc với sửa lại 😗.
...
🤡 These English part is what I really thought but I also got this from Gemini. Best support.